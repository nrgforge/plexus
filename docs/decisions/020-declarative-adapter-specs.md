...
**Status:** Accepted (naming superseded by [ADR-028](028-universal-mcp-ingest.md) — `DeclarativeAdapter` renamed to `SemanticAdapter`; architectural decisions remain valid)
